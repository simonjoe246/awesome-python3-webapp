...
def get_named_kw_args(fn):
    '''
    get the named keyword arguments of fn
    :param fn:
    :return:
    '''
    args = []
...
def has_request_args(fn):
    ...
    VAR_POSITIONAL:可变参数
    POSITIONAL-OR-KEYWORD: 默认参数
    POSITIONAL-ONLY: 位置参数
    VAR_KEYWORD: 关键字参数
    :param fn:
    :return:
    '''
            ...
            if request.method == 'POST':
                ...
                if ct.startswith('application/json'):
                    ...
                    if not isinstance(params, dict):
                        return web.HTTPBadRequest('JSON body must be dict')
                    kw = params
                # 提交form表
